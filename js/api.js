...
const ARTEMIS_API_URL = 'https://script.google.com/macros/s/AKfycbweFCxva_Ya1FwOaU45VQcmVaI23B4HKrui96Ow5lt2l3qVVb9c6Jhhv8nV6WqvOBX-/exec';
...
class VectorEmbeddingEngine {
    ...
    async initialize(statusCallback) {
        ...
        try {
            ...
            env.remoteHost = 'https://cdn.jsdelivr.net/npm/@huggingface/transformers/';
